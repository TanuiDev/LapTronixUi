        ...
        <div className="w-full md:w-1/2 mb-8">
          ...
          <form className=" max-w-lg mx-auto p-4 border rounded shadow">
            ...
            <div className="text-center">
              <button className="bg-blue-600 text-white w-full px-4 py-2 rounded hover:bg-blue-700" type="submit">Send Message</button>
            </div>
          </form>
        </div>
        <div className="w-full md:w-1/2">
          <h2 className="text-xl md:text-2xl text-center font-bold mb-4">Contact Information</h2>          
